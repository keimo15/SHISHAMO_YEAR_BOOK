      ...
      >
        ...
        >
          <g className="prefectures" transform="matrix(1, 0, 0, 1, 6, 18)">
            ...
            {/* 沖縄 */}
            <g
              className="okinawa kyusyu-okinawa prefecture"
              data-code="47"
              stroke="#000000"
              strokeWidth="1.0"
            ...
            {/* 鹿児島 */}
            <g
              className="kagoshima kyusyu kyusyu-okinawa prefecture"
              data-code="46"
              stroke="#000000"
              strokeWidth="1.0"
            ...
            {/* 宮崎 */}
            <g
              className="miyazaki kyusyu kyusyu-okinawa prefecture"
              data-code="45"
              stroke="#000000"
              strokeWidth="1.0"
            ...
            {/* 大分 */}
          <g
            className="oita kyusyu kyusyu-okinawa prefecture"
            data-code="44"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 長崎 */}
          <g
            className="nagasaki kyusyu kyusyu-okinawa prefecture"
            data-code="42"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 佐賀 */}
          <g
            className="saga kyusyu kyusyu-okinawa prefecture"
            data-code="41"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 福岡 */}
          <g
            className="fukuoka kyusyu kyusyu-okinawa prefecture"
            data-code="40"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 山口 */}
          <g
            className="yamaguchi chugoku prefecture"
            data-code="35"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 広島 */}
          <g
            className="hiroshima chugoku prefecture"
            data-code="34"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 岡山 */}
          <g
            className="okayama chugoku prefecture"
            data-code="33"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 島根 */}
          <g
            className="shimane chugoku prefecture"
            data-code="32"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 鳥取 */}
          <g
            className="tottori chugoku prefecture"
            data-code="31"
            stroke="#000000"
            strokeWidth="1.0"
          ...
          {/* 滋賀 */}
          <g
            className="shiga kinki prefecture"
            data-code="25"
            stroke="#000000"
            strokeWidth="1.0"
